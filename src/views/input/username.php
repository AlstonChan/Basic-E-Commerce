<div class="field">
    <label class="label" for="username_<?php echo $params[
        'type'
    ]; ?>">Username</label>
    <p class="control has-icons-left has-icons-right">
        <input class="input" type="text" placeholder="Username" name="username_<?php echo $params[
            'type'
        ]; ?>" id="username_<?php echo $params['type']; ?>" value="<?php if (
    isset($input_value)
) {
    echo $input_value;
} ?>">
