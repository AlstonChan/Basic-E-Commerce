    ...
    <section class="mt-8 px-5">
        <div class="max-w-6xl-md flex mx-auto justify-center">
            <div class="aspect-square max-w-sm w-1/3">
                <img src="<?php echo $currentProduct['thumbnail']; ?>"
                ...
                <div class="content has-background-light py-2 px-5" style="border-radius:8px">
                    ...
                    <div class="rating rating-md rating-half my-3">
                        <?php for ($i = 0; $i < 10; ++$i) { ?>
                            <input type="radio"
                                   name="rating-10"
                                   class="bg-orange-500 mask mask-star-2 mask-half-<?php echo ($i % 2) + 1; ?>"
                                   disabled="true"
                                   <?php
                                    echo (int) (round($currentProduct['rating'] * 2) / 2) === ($i + 1) / 2
                                        ? 'checked="true"'
                                        : null; ?> />
                        <?php } ?>
                    </div>
                    <p class="mb-3 text-lg">
                        ...
                        tristique sollicitudin nibh. Senectus et netus et malesuada fames ac turpis.
                    </p>
                    <div class="badge badge-accent">
                        <?php echo $currentProduct['brand']; ?>
                    </div>
                    <form class="my-6" x-data="{
                            cartNum: 1,
                            validateNum(e) {
